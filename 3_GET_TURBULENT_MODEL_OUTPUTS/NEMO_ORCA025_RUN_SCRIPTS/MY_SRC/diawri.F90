...
# if defined key_iomput
   ...
   SUBROUTINE dia_wri( kt )
     ...
     !####################################################################################################
     !!!2018-12-20 declared and read namelist variable ln_ens_diag (would not compile without declaration)
!      NAMELIST/nammpp/ ln_ens_diag
!      LOGICAL :: ln_ens_diag = .false.
     !####################################################################################################
...
!####################################################################################################
!!!2018-12-20 commented unneeded region preventing compilation
!####################################################################################################
